...
//----------EFECTOS DE IMÁGENES----------//
const images = document.querySelectorAll('.primero, .segundo, .dropdown1, .losdescalzos, .dropdown2, .dropdown');

function triggerAnimation(entries){
    entries.forEach(entry =>{
        const image = entry.target.querySelector('h1, div, button,div');
